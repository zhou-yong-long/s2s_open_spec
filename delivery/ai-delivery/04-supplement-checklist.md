...
详见仓库根 [README.md](../../README.md) 的 *Offline install bundle* 小节。打好的 zip 内附带 **`delivery/`** 完整副本；平时也可直接分发仓库内 [`delivery/`](../../delivery/README.md) 文件夹（先执行 `npm run delivery:sync` 与 `docs/` 对齐）。
